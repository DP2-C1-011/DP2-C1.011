...
<acme:form>
	...
	<acme:input-email code="authenticated.developer.form.label.contactEmail" path="contactEmail"/>
	<acme:input-url code="authenticated.developer.form.label.optionalLink" path="optionalLink"/>
